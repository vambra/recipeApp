...
var storageKey = '@categoryKey';

function CategoryCommentScreen({ route, navigation }) {
    if (route != null)
        storageKey = "@categoryKey_" + route.params.params.name;
    console.log("category key: " + storageKey);
...
export default CategoryCommentScreen;